...
export default function SkillAndAbility() {
  return (
    <section className="bg-dark2 py-24 2xl:py-28 overflow-hidden">
      <div className="container relative">
        <Image className="hidden 2xl:block pointer-events-none w-[150px] 2xl:w-[200px] absolute top-[2%] 2xl:top-[10%] left-0 2xl:left-auto 2xl:right-full z-0" src="/images/circles/item.png" width={200} height={150} alt="" />
            <Image className="hidden sm:block pointer-events-none w-[60px] 2xl:w-auto move-x absolute bottom-[-56px] 2xl:bottom-0 mt-4 left-4 2xl:left-[-10%]" src="/images/circles/item2.png" width={60} height={60} alt="" />
        <div className="flex flex-wrap items-center -mx-4">
          <div className="order-2 md:order-1 w-full md:w-7/12 lg:pr-20 px-4">
            <SectionTitle title="SKILLS &amp; ABILITIES" descClass="text-white">
            ...
            <div className="mt-16 2xl:mt-20 space-y-12">
              <Progress label="Business Strategy" bgClass="bg-green-light" value="60%" />
              <Progress label="Technology Consulting" bgClass="bg-primary" value="78%" />
              <Progress label="Product Development" bgClass="bg-primary" value="96%" />
            </div>
          </div>
