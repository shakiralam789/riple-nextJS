  ...
  return (
    <section id="banner" className="bg-dark2 overflow-hidden">
        <div className="container relative text-white flex items-center">
            ...
            <img className="hidden sm:block pointer-events-none w-[60px] 2xl:w-auto move-x absolute bottom-[5%] 2xl:bottom-[20%] left-0 2xl:left-[-10%]" src="./image/circles/item2.png" alt="">
            <img className="hidden sm:block pointer-events-none w-[40px] 2xl:w-auto move-y absolute bottom-[20%] right-[5%] 2xl:right-[-10%]" src="./image/circles/item-up.png" alt=""> */}
            ...
            <div className="grid grid-cols-12 gap-4 relative z-10">
                <div className="col-span-12 md:col-span-7 lg:col-span-6 pt-20 lg:pt-32 2xl:pt-36 pb-24 lg:pb-36 2xl:pb-40">
                    ...
                    <h1 className="font-66 font-bold mt-3">
                        Learn <span className="text-primary">Technology
                            From All</span> Experts
                    </h1>
                    <p className="font-18 text-gray-light leading-loose mt-4">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod cupidatat non proident,
                ...
                <div className="hidden md:flex col-span-5 lg:col-span-6 items-end justify-end">
                    <div className="relative lg:-mb-20 2xl:-mb-10">
                        <div className="w-[65%] aspect-square absolute top-[-25%] left-[53%] lg:left-[45%] 2xl:left-1/2 -translate-x-1/2 mr-[10%] 2xl:mr-[4%]">
                            {/* <img className="hidden sm:block pointer-events-none absolute top-1/2 -translate-y-1.2 left-[-40px]" src="./image/circles/Ellipse3.png" alt="">
                            ...
                            <img className="hidden sm:block pointer-events-none rotate-right w-full h-full" src="./image/circles/miving-cricle.png" alt="">
                            <img className="hidden sm:block pointer-events-none inner-right-with-translate w-[50%] aspect-square absolute top-1/2 left-1/2 z-10" src="./image/circles/moving-elipse-md.png" alt=""> */}

                            <div className="rotate-left w-[90%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                                <svg className="w-full aspect-square text-white" stroke="currentColor" fill="currentColor" viewBox="0 0 100 100">
                                    <defs>
                                        <path id="circle" d="
                                      M 50, 50
                                      m -37, 0
                                    ...
                                    {/* <text font-size="17">
                                        <textPath xlink:href="#circle" className="text-[15px]">
                        ...
                        {/* <img className="w-[95%] lg:w-[80%] 2xl:w-[90%] relative z-20" src="./image/student-banner.png" alt="hero image"> */}
                    </div>
                </div>
            </div>
        </div>
