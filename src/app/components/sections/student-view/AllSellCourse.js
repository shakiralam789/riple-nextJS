    ...
    <section className="py-24 2xl:py-28">
      <div className="container">
        <div className="w-full md:w-[90%] lg:w-[60%]">
          <h2 className="font-30 text-primary uppercase">ALL SELL COURSES</h2>
          <p className="font-48 text-dark2 mt-6 font-bold">
          ...
          <div className="group relative p-4 2xl:p-6 bg-gray-light2 hover:bg-dark-green">
            <div className="hidden group-hover:block absolute inset-2 border-white/50 border-2">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 h-2.5 -translate-y-1/2 w-20 flex justify-center items-center bg-dark-green">
                ...
                >
                  <path
                    d="M25.2354 0.642353L27.6177 4.81741L30 8.99194L25.287 9.02099L20.574 9.05004L22.9047 4.84646L25.2354 0.642353Z"
                    fill="white"
                  ></path>
                  <path
                    d="M5.23537 0.642353L7.61769 4.81741L10 8.99194L5.28701 9.02099L0.574031 9.05004L2.9047 4.84646L5.23537 0.642353Z"
                    fill="white"
                  ></path>
                  <path
                    d="M35.2354 9.02098L37.6177 4.84592L40 0.671387L35.287 0.642338L30.574 0.613289L32.9047 4.81687L35.2354 9.02098Z"
                    fill="white"
                  ></path>
                  <path
                    d="M15.2354 9.02098L17.6177 4.84592L20 0.671387L15.287 0.642338L10.574 0.613289L12.9047 4.81687L15.2354 9.02098Z"
                    fill="white"
                  ></path>
                </svg>
              </div>
