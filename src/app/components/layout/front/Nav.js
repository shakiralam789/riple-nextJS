...
export default function Nav() {
  return (
    <header className="bg-dark2">
      <div className="container relative">
        <div className="flex justify-between items-center h-[90px] 2xl:h-[120px]">
          ...
          <div className="flex space-x-6 items-center">
            ...
            >
              <svg
                className="group-[.active]/menu:hidden size-7"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="2"
      ...
      <div
        id="overlay"
        className="fixed md:hidden top-0 left-0 w-full h-screen bg-black pointer-events-none [&amp;.active]:pointer-events-auto opacity-0 [&amp;.active]:opacity-50 duration-300"
      ></div>
      <div
        id="menu"
        className="md:hidden translate-x-full [&amp;.active]:translate-x-0 duration-300 z-50 custom-shadow-1 w-[250px] h-screen overflow-y-scroll fixed top-0 right-0 bg-dark-green shadow-md"
      >
